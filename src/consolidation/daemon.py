...
def _build_model(cfg: dict):
    ...
    from src.config import get_precision, load_tokenizer_info, unified_vocab_size
...
def run_consolidation(cfg: dict) -> None:
    ...
    from src.memory.experience_log import clear_experiences, load_experiences
    ...
    from src.training.curriculum import last_cognitive_stage
...
def main():
    ...
    from src.config import load_config, require_backend, resolve_config_path
