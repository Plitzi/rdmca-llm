...
from src.stages._shared.blend import cycle_records, interleave
from src.stages._shared.dictionary import DICT_TIERS
from src.stages._shared.persona import (
    STORY_PROMPTS,
    hash01,
    persona_for,
    prepend_system,
