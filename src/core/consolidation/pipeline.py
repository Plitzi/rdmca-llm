...
from src.core.memory.mrf import mrf
from src.core.model.bcf import BCFHead
from src.core.relevance.engine import RelevanceEngine
from src.core.routing.semantic_router import Chunk
...
class ConsolidationPipeline:
    ...
    def run(self) -> AuditEntry:
        ...
        for exp, score in consistent:
            ...
            if fate == "promote":
                from src.core.memory.ltss import LTSSNode
