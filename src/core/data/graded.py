...
`src/stages/stageNN_<slug>/sources.py`, with cross-stage helpers in the framework
core (`src/core/data/`). The source dispatcher is the stage registry
...
# Shared helpers.
from src.core.data.blend import (  # noqa: F401
    _blend,
    _cycle_records,
    _interleave,
    blend,
...
from src.stages.stage01_language.dictionary import (  # noqa: F401
    _DICT_TIER1,
    _DICT_TIER2,
    _DICT_TIERS,
)
from src.core.data.persona import (  # noqa: F401
    _STORY_PROMPTS,
    _hash01,
    _persona_for,
    _prepend_system,
)
from src.core.data.textfilter import (  # noqa: F401
    _stable_hash,
