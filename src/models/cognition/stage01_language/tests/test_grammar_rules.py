...
from src.models.cognition.stage01_language.sources import _PAST_IRREG, _PLURAL_IRREG, gen_grammar
...
def test_vocab_scales_with_level():
    ...
    from src.models.cognition.stage01_language.dictionary import _DICT_TIERS
