...
Usage:
  python src/models/cognition/experiments/continual_learning.py
  python src/models/cognition/experiments/continual_learning.py --domains 5 --steps 300 --d_model 128
"""
import argparse
import time
