...
# Reuse the core building blocks (this module is imported lazily from
# RDMCAFoundational.__init__, so transformer.py is fully loaded by now).
from src.model.transformer import RMSNorm, SwiGLU
