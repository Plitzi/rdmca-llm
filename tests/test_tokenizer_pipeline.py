...
def _train_tiny(tmp_path) -> "spm.SentencePieceProcessor":
    ...
    lines = []
    base_en = ["the cat sat on the mat", "hello there how are you",
               "a small fox runs fast", "what is a car please tell me",
               "i am doing well thank you"]
    base_es = ["el gato se sento en la alfombra", "hola como estas hoy",
               "un zorro pequeno corre rapido", "que es un coche por favor"]
    ...
    spm.SentencePieceTrainer.Train(
        input=str(corpus), model_prefix=prefix, vocab_size=512,
