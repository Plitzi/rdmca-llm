...
```bash
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10                 # streamed, reasoning=medium (defaults)
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --format json   # JSON output
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --think high     # more reasoning
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --no-stream      # batched (no live tokens)
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --quant int4     # 4-bit weights (limited hardware)
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --quant 8        # any 2–8 bit width works too
python models/cognition/uses/chat/run_chat.py --dummy                              # random weights (plumbing only)
```
