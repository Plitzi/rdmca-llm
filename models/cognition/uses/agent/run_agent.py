...
Usage:
  ...
  python models/cognition/uses/agent/run_agent.py --dummy --query "hello"     # plumbing only (random weights)
...
REPO = Path(__file__).resolve().parents[4]  # models/cognition/uses/agent/ → repo
sys.path.insert(0, str(REPO))

from models.cognition.uses.agent.tools.current_time import TOOL as CURRENT_TIME
from models.cognition.uses.agent.tools.todo import TOOL as TODO
from models.cognition.uses.chat import (
    run_chat as chat,
...
def main() -> None:
    ...
    from models.cognition.mood import MOODS, classify_mood, load_mood_head, mood_system_phrase
