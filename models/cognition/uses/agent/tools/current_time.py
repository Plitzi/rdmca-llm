...
`TOOL` of type `models.cognition.uses.common.agent.Tool` with a name, description, JSON input_schema and a
...
from models.cognition.uses.common.agent import Tool
