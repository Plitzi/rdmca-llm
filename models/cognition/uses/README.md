...
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --format json
python models/cognition/uses/chat/run_chat.py --level 1 --stage 10 --think high --no-stream
