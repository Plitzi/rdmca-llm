...
def _full_corpus_streamers(stage: int, langs: list[str], limit_mb: int | None) -> dict:
...
def prepare_stage_for_level(
    ...
    from src.stages import stream_source
    from src.stages._shared.text import passes_filter
...
def main():
    ...
    from src.config import MAX_LEVEL, get_languages, get_level, load_config, resolve_config_path
